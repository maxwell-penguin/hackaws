...
export interface ApiDeltaEventDeltaEvent extends Struct.CollectionTypeSchema {
  collectionName: 'delta_events';
  info: {
    description: '';
    displayName: 'DeltaEvent';
    pluralName: 'delta-events';
    singularName: 'delta-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    geminiRawResponse: Schema.Attribute.JSON;
    itemsFlagged: Schema.Attribute.Relation<'manyToMany', 'api::item.item'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deltaEvents: Schema.Attribute.Relation<
      'manyToMany',
      'api::delta-event.delta-event'
    >;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::delta-event.delta-event': ApiDeltaEventDeltaEvent;
